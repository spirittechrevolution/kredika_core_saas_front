          ...
          <div class="mt-8 px-4 sm:px-0">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <a
                ...
                class="block bg-white overflow-hidden shadow rounded-lg hover:shadow-lg transition-shadow cursor-pointer"
              >
                <div class="p-5">
                  <div class="flex items-center">
                    <div class="flex-shrink-0">
              ...
              >
                <div class="p-5">
                  <div class="flex items-center">
                    ...
                    <div class="ml-3">
                      <p class="text-sm font-medium text-gray-900">Gérer les partenaires</p>
                    </div>
                  </div>
                </div>
              </a>
              ...
              >
                <div class="p-5">
                  <div class="flex items-center">
                    ...
                    <div class="ml-3">
                      <p class="text-sm font-medium text-gray-900">Voir les échéances</p>
                    </div>
                  </div>
                </div>
              </a>
